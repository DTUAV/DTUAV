...
{
    public class LocalNetworkMsgPackNode : MonoBehaviour
    {
        ...
        void Start()
        {
           _globalNetworkPack = new LocalNetworkPack(IsSendGlobalPosition,IsSendLocalPosition,IsSendVelocity,GlobalPositionMsgSubName,LocalPositionMsgSubName,CurrentVelocityMsgSubName,GlobalNetworkMessagePubName,SourceId,TargetId);
