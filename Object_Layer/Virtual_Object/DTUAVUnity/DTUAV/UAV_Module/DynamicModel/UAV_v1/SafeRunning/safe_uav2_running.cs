...
namespace RosSharp.RosBridgeClient
{
    ...
    {
        public GameObject Uav;//UAV object
        public float FixedUpdateTime;//Fixedupdate function run interval
        public float MsgPubHz;//Frequency of collision detection
        public DroneV2XYZControl UavControl;//UAV control script
