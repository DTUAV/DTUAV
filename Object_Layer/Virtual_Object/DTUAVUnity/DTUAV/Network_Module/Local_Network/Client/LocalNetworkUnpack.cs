...
{
    public class LocalNetworkUnpack
    {
        ...
        internal class LcmIotMessageSubscriber : LCMSubscriber
        {
            ...
            public LcmIotMessageSubscriber(LocalNetworkUnpack globalNetworkUnpack)
            {
