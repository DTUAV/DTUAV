...
namespace DTUAV.Network_Module.Matlab
{
    ...
    public class UAVMatlabPosition : MonoBehaviour
    {
        ...
        void Recv()
        {
            ...
            while (!_endFlag)
            {
                try
                {
                    ...
                    Quaternion rotation = new Quaternion((float)_targetLocalPosition.rotation_x,(float)_targetLocalPosition.rotation_y,(float)_targetLocalPosition.rotation_z,(float)_targetLocalPosition.rotation_w);
                    PositionNode.RefRotationRos.x = rotation.eulerAngles.x;
                    PositionNode.RefRotationRos.y = rotation.eulerAngles.y;
                    PositionNode.RefRotationRos.z = rotation.eulerAngles.z;
                }
                catch
                {
