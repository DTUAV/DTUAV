...
void v_uav_local_network::timerEvent(QTimerEvent *event)
{
  if(event->timerId() == m_nTimerID){
    ui_update_timeout();
  }
}
void v_uav_local_network::ui_update_timeout()
{
...
void v_uav_local_network::on_v_uav_0_takeoff_button_clicked()
{
...
void v_uav_local_network::on_v_uav_0_land_button_clicked()
{
    geometry_msgs::PoseStamped ref_msg;
    ref_msg.pose.position.x = _current_pose.pose.position.x;
    ref_msg.pose.position.y = _current_pose.pose.position.y;
...
void v_uav_local_network::on_v_uav_0_ref_pub_button_clicked()
{
  ...
  _target_move_track_msg.header.frame_id="v_uav_local";
  geometry_msgs::PoseStamped this_pose_stamped;
...
void v_uav_local_network::on_v_uav_0_init_button_clicked()
{
    std_msgs::Bool system_start_msg;
    system_start_msg.data = true;
    _system_start_pub.publish(system_start_msg);
}
void v_uav_local_network::on_v_uav_0_link_button_clicked()
{
...
void v_uav_local_network::on_v_uav_0_disconnect_button_clicked()
{
