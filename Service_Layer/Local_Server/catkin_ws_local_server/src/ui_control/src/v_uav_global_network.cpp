...
#include "ui_v_uav_global_network.h"
bool v_uav_global_network::set_object_id(int id)
{
    _object_id = id;
    return true;
}
void v_uav_global_network::camera_sub_cb(const sensor_msgs::CompressedImage::ConstPtr &msg)
{
  cv_bridge::CvImagePtr cv_ptr_compressed = cv_bridge::toCvCopy(msg,sensor_msgs::image_encodings::BGR8);
  _camera_data = cv_ptr_compressed->image;
}

void v_uav_global_network::current_position_sub_cb(const geometry_msgs::PoseStamped::ConstPtr &msg)
{
  _current_pose.pose = msg.get()->pose;
  _current_move_track_msg.header.frame_id="v_uav_global";
  ...
  this_pose_stamped.header.frame_id="v_uav_global";
  _current_move_track_msg.poses.push_back(this_pose_stamped);
  _movement_track_pub.publish(_current_move_track_msg);
}

bool v_uav_global_network::set_network_name(std::string networkName)
{
_network_name = networkName;
return true;
}

bool v_uav_global_network::set_object_name(std::string objectName)
{
    _object_name = objectName;
    return true;
}

void v_uav_global_network::init_ros()
{
    ros::NodeHandle n("~");
    ...
    _link_network_pub_topic = "/"+_object_name+"/"+_network_name+tempString;
     ...
     _current_pose_sub = n.subscribe(_current_pose_sub_topic,1,&v_uav_global_network::current_position_sub_cb,this);
     _movement_track_pub = n.advertise<nav_msgs::Path>(_movement_track_pub_topic,1);
     _current_camera_sub = n.subscribe(_current_camera_sub_topic,1,&v_uav_global_network::camera_sub_cb,this);
...
v_uav_global_network::v_uav_global_network(QWidget *parent) :
  QMainWindow(parent),
  ui(new Ui::v_uav_global_network)
{
  ui->setupUi(this);
...
v_uav_global_network::~v_uav_global_network()
{
  this->killTimer(m_nTimerID);
  delete ui;
}

void v_uav_global_network::timerEvent(QTimerEvent *event)
{
  if(event->timerId() == m_nTimerID){
    ui_update_timeout();
  }
}
void v_uav_global_network::ui_update_timeout()
{
...
void v_uav_global_network::on_v_uav_0_takeoff_button_clicked()
{
...
void v_uav_global_network::on_v_uav_0_land_button_clicked()
{
    geometry_msgs::PoseStamped ref_msg;
    ref_msg.pose.position.x = _current_pose.pose.position.x;
    ref_msg.pose.position.y = _current_pose.pose.position.y;
...
void v_uav_global_network::on_v_uav_0_ref_pub_button_clicked()
{
  ...
  _target_move_track_msg.header.frame_id="v_uav_global";
  geometry_msgs::PoseStamped this_pose_stamped;
...
void v_uav_global_network::on_v_uav_0_mission_start_button_clicked()
{
...
void v_uav_global_network::on_v_uav_0_init_button_clicked()
{
    std_msgs::Bool system_start_msg;
    system_start_msg.data = true;
    _system_start_pub.publish(system_start_msg);
}
void v_uav_global_network::on_v_uav_0_link_button_clicked()
{
...
void v_uav_global_network::on_v_uav_0_disconnect_button_clicked()
{
...
void v_uav_global_network::on_v_uav_0_camera_open_button_clicked()
{
...
void v_uav_global_network::on_v_uav_0_camera_close_button_clicked()
{
    std_msgs::Bool request_camera_data_msg;
