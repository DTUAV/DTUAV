...
*/
#ifndef R_UAV_GLOBAL_NETWORK_H
#define R_UAV_GLOBAL_NETWORK_H
...
namespace Ui {
class r_uav_global_network;
}

class r_uav_global_network : public QMainWindow
{
  Q_OBJECT

public:
  explicit r_uav_global_network(QWidget *parent = 0);
  ~r_uav_global_network();
public:
