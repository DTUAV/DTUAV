...
*/
#ifndef R_UAV_LOCAL_NETWORK_H
#define R_UAV_LOCAL_NETWORK_H
...
namespace Ui {
class r_uav_local_network;
}

class r_uav_local_network : public QMainWindow
{
  Q_OBJECT

public:
  explicit r_uav_local_network(QWidget *parent = 0);
  ~r_uav_local_network();
public:
