...
*/
#ifndef V_UAV_GLOBAL_NETWORK_H
#define V_UAV_GLOBAL_NETWORK_H
...
namespace Ui {
class v_uav_global_network;
}

class v_uav_global_network : public QMainWindow
{
  Q_OBJECT

public:
  explicit v_uav_global_network(QWidget *parent = 0);
  ~v_uav_global_network();
public:
