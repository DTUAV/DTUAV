...
public:
  mission_point();
  void mission_control_cb(const dt_message_package::mission_msgConstPtr& msg);
...
private:
  ...
  std::string _mission_1_file_name;
  std::string _mission_2_file_name;
  std::string _mission_3_file_name;
  ...
  int _mission_1_count;
  int _mission_2_count;
  int _mission_3_count;
  ...
  std::vector<ref_state_stu> _mission_1_ref_state_vector;
  std::vector<ref_state_stu> _mission_2_ref_state_vector;
  std::vector<ref_state_stu> _mission_3_ref_state_vector;
};
